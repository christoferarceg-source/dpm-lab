...
- **Learn** (`/`): a path of 8 units: Level 0 (SQL & Python 101, 8 lessons), a closing Toolbox unit on industry tools,
...
- **XP and levels**: 10 XP per lesson, +5 for a perfect run, 20 XP per Lab
  ...
  progress per unit.
- **Review**: 43 SM-2 spaced-repetition flashcards.
- **Story** (`/chapters/n`) and **Library** (`/kb`, 27 entries): the briefs,
...
content/
  lessons.ts          47 micro-lessons (concept + 5 items each), units and colours
