...
**source-aligned** product if it had a contract and an owner.`,source:"Modern Data 101 (Defining the True Data Product; Anatomy; Canonical Core; product types), from the user's notes."},{slug:"modern-data-stack-map",title:"The Modern Data Stack: a Map",category:"definition",tags:["tools","architecture","industry"],summary:"Where each category of tool sits between a source system and a decision, which vendors lead each category, and which pieces of Meridian's stack they correspond to.",body:`Vendors change; the layers don't. Read the stack left to right, the way data
...
says "we're evaluating a Magic Quadrant leader," ask which row.`,source:"Synthesized for DPM Lab; category structure follows Gartner's data & analytics markets."},{slug:"tools-warehouses-lakehouses",title:"Warehouses and Lakehouses: Snowflake, Databricks, BigQuery, Redshift, Fabric",category:"definition",tags:["tools","warehouse","lakehouse","snowflake","databricks"],summary:"The platforms where data lands and SQL runs. How each one thinks, what it charges you for, and the questions a Data PM asks before a workload lands on it.",body:`All five do the same core job: store large tables and run SQL over them at
...
- **Can we share it without copying it?** Snowflake sharing and Delta Sharing let you publish a data product to another team or company as a live view.`,source:"Synthesized for DPM Lab from vendor documentation and public positioning (as of 2026)."},{slug:"tools-integration-pipelines",title:"Moving and Shaping Data: Fivetran, Airbyte, dbt, Airflow, Kafka, Informatica, Talend, Ab Initio",category:"definition",tags:["tools","integration","etl","elt","streaming","ab-initio"],summary:"The tools that get data from sources into the warehouse and turn it into modelled tables: managed connectors, SQL transformation, orchestration, streaming, and the enterprise ETL suites.",body:`Two generations coexist. **Enterprise ETL suites** (Informatica, Talend, Ab
...
- **How does a schema change upstream reach us?** A renamed CRM field can silently zero a metric.`,source:"Synthesized for DPM Lab from vendor documentation and public positioning (as of 2026)."},{slug:"tools-bi-semantic-layer",title:"Seeing the Data: Tableau, Power BI, Looker, Qlik, Metabase, Redash",category:"definition",tags:["tools","bi","dashboards","semantic-layer","tableau"],summary:"BI tools are the consumption layer. The important difference between them is where the metric definition lives: in each dashboard, or in a governed semantic layer everyone reads.",body:`Remember week 2: a dashboard is not the data product; it reads one. The
...
- **What happens when the definition changes?** One edit in a semantic layer, or twenty workbooks?`,source:"Synthesized for DPM Lab from vendor documentation and public positioning (as of 2026)."},{slug:"tools-quality-governance-catalog",title:"Trusting and Governing: Monte Carlo, Great Expectations, Soda, Collibra, Alation, Atlan, Unity Catalog, DataOS",category:"definition",tags:["tools","data-quality","observability","catalog","governance","dataos"],summary:"The tools that turn week 3's SLOs into monitors, make data findable, and encode who may see what. Also where data product platforms like DataOS sit.",body:`Week 3 wrote SLOs as queries. These tools run them for you, tell people
...
- **Does the ontology from week 6 live in a tool, or in a slide?**`,source:"Synthesized for DPM Lab from vendor documentation and public positioning (as of 2026)."},{slug:"tools-ml-platforms",title:"Data Science and ML Platforms: MLflow, SageMaker, Vertex AI, Dataiku, Notebooks",category:"definition",tags:["tools","ml","notebooks","mlflow"],summary:"Where models are built, tracked, and served, and what a Data PM needs from them: reproducibility, a registry, and evaluation before anything reaches a decision.",body:`A Data PM rarely trains models, but often owns the data products they
...
5. **Cost per correct prediction**, the Lean AI metric.`,source:"Synthesized for DPM Lab from vendor documentation and public positioning (as of 2026)."}];e.s(["kbEntries",0,t])}]);