(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,17408,e=>{"use strict";var t=e.i(18050),a=e.i(22016),s=e.i(71645),o=e.i(87110),r=e.i(82364);let i=["all","framework","definition","case-study","industry-context"];e.s(["default",0,function(){let[e,n]=(0,s.useState)(""),[l,c]=(0,s.useState)("all"),d=(0,s.useMemo)(()=>{let t=e.trim().toLowerCase();return o.kbEntries.filter(e=>("all"===l||e.category===l)&&(!t||e.title.toLowerCase().includes(t)||e.summary.toLowerCase().includes(t)||e.tags.some(e=>e.includes(t))||e.body.toLowerCase().includes(t)))},[e,l]);return(0,t.jsxs)("div",{className:"space-y-6",children:[(0,t.jsxs)("div",{children:[(0,t.jsx)("h1",{className:"text-2xl font-semibold tracking-tight",children:"Knowledge Base"}),(0,t.jsxs)("p",{className:"text-muted mt-1",children:[o.kbEntries.length," entries, seeded from your PRD, the 6-Week Playbook, State of Data Products Q2 2026, and the Big Book of Data Science."]})]}),(0,t.jsxs)("div",{className:"flex flex-col sm:flex-row gap-3",children:[(0,t.jsx)("input",{value:e,onChange:e=>n(e.target.value),placeholder:"Search titles, tags, body…",className:"flex-1 px-3 py-2 rounded-md border border-border bg-surface text-sm focus:outline-none focus:ring-2 focus:ring-accent-soft"}),(0,t.jsx)("div",{className:"flex gap-1 overflow-x-auto",children:i.map(e=>(0,t.jsx)("button",{onClick:()=>c(e),className:`px-3 py-1.5 rounded-md text-sm whitespace-nowrap ${l===e?"bg-accent-soft text-accent font-medium":"text-muted hover:bg-surface-2"}`,children:"all"===e?"All":r.CATEGORY_LABELS[e]},e))})]}),(0,t.jsxs)("ul",{className:"grid gap-3 sm:grid-cols-2",children:[d.map(e=>(0,t.jsx)("li",{children:(0,t.jsxs)(a.default,{href:`/kb/${e.slug}`,className:"block h-full bg-surface border border-border rounded-xl p-4 hover:border-accent transition-colors",children:[(0,t.jsx)("div",{className:"flex items-center gap-2 text-xs text-muted",children:(0,t.jsx)("span",{className:"px-2 py-0.5 rounded-full bg-surface-2",children:r.CATEGORY_LABELS[e.category]})}),(0,t.jsx)("h2",{className:"font-semibold mt-2",children:e.title}),(0,t.jsx)("p",{className:"text-sm text-muted mt-1",children:e.summary}),(0,t.jsx)("p",{className:"text-xs text-muted mt-3",children:e.tags.map(e=>`#${e}`).join("  ")})]})},e.slug)),0===d.length&&(0,t.jsx)("li",{className:"text-sm text-muted",children:"No entries match."})]})]})}])},87110,e=>{"use strict";let t=[{slug:"what-is-a-data-product-manager",title:"What is a Data Product Manager?",category:"definition",tags:["role","fundamentals"],summary:"A DPM sits at the intersection of data, technology, and business, managing data warehouses, platforms, pipelines, and ML models the way a PM manages a product.",body:`A **Data Product Manager (DPM)** is a specialized role at the intersection of
