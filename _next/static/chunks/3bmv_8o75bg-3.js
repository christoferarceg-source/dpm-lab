(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,82221,e=>{"use strict";var t=e.i(18050),o=e.i(22016),a=e.i(6e4),n=e.i(47371),s=e.i(8908),r=e.i(79922),i=e.i(74581),l=e.i(7664);let d=[0,44,64,44,0,-44,-64,-44];function c(){return(0,t.jsx)("svg",{width:"26",height:"26",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"3",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,children:(0,t.jsx)("path",{d:"M5 13l4 4L19 7"})})}function u(){return(0,t.jsx)("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,children:(0,t.jsx)("path",{d:"M9 3h6M10 3v6l-5.5 9a2 2 0 0 0 1.7 3h11.6a2 2 0 0 0 1.7-3L14 9V3"})})}function h(){return(0,t.jsx)("svg",{width:"26",height:"26",viewBox:"0 0 24 24",fill:"currentColor","aria-hidden":!0,children:(0,t.jsx)("path",{d:"M12 2.5l2.9 6 6.6.9-4.8 4.6 1.2 6.5L12 17.4 6.1 20.5l1.2-6.5L2.5 9.4l6.6-.9z"})})}e.s(["LearnPath",0,function(){let{data:e,hydrated:m}=(0,i.useProgress)(),g=(0,r.allUnitProgress)(e),p=m?(0,r.nextLesson)(e):null,E=(0,l.computeXp)(e),_=(0,l.levelFor)(E.total);return(0,t.jsxs)("div",{className:"space-y-8",children:[(0,t.jsxs)("div",{className:"flex items-center justify-between gap-3",children:[(0,t.jsxs)("div",{children:[(0,t.jsx)("h1",{className:"text-xl sm:text-2xl font-semibold tracking-tight",children:"Six weeks as a Data PM"}),(0,t.jsx)("p",{className:"text-sm text-muted",children:"One-minute lessons. Real labs. Meridian's data has problems planted in it."})]}),m&&(0,t.jsxs)(o.default,{href:"/profile",className:"shrink-0 text-right",children:[(0,t.jsxs)("p",{className:"text-xs uppercase tracking-wide text-muted",children:["Level ",_.level]}),(0,t.jsxs)("p",{className:"font-semibold tabular-nums",children:[E.total," XP"]}),(0,t.jsx)("p",{className:"text-[0.7rem] text-muted",children:(0,l.levelTitle)(_.level)})]})]}),a.units.map((a,r)=>{let i=g[r],l=(0,s.sqlExercisesForChapter)(a.number),E=l.length?`/practice/sql#${l[0].slug}`:"/practice";return(0,t.jsxs)("section",{className:"space-y-4",children:[(0,t.jsxs)("div",{className:"rounded-2xl p-4 sm:p-5 text-white flex items-start justify-between gap-3",style:{background:a.color},children:[(0,t.jsxs)("div",{className:"min-w-0",children:[(0,t.jsx)("p",{className:"text-[0.7rem] uppercase tracking-wide opacity-80",children:a.week}),(0,t.jsx)("h2",{className:"text-lg font-semibold leading-tight",children:a.title}),(0,t.jsx)("p",{className:"text-sm opacity-90 mt-0.5",children:a.tagline})]}),(0,t.jsxs)("div",{className:"shrink-0 text-right",children:[(0,n.getChapter)(a.number)?(0,t.jsx)(o.default,{href:`/chapters/${a.number}`,className:"inline-block text-xs font-medium bg-white/20 hover:bg-white/30 rounded-md px-2.5 py-1.5",children:"Story"}):(0,t.jsx)("span",{className:"inline-block text-xs font-medium bg-white/20 rounded-md px-2.5 py-1.5",children:"Basics"}),m&&(0,t.jsxs)("p",{className:"text-xs opacity-80 mt-2 tabular-nums",children:[i.lessonsDone,"/",i.lessonsTotal," lessons"]})]})]}),(0,t.jsxs)("ol",{className:"flex flex-col items-center gap-11 py-4 pb-10",children:[a.lessons.map((n,s)=>{let r=!!e.lessons[n.id],i=p?.id===n.id,l=d[s%d.length];return(0,t.jsxs)("li",{className:"relative",style:{transform:`translateX(${l}px)`},children:[i&&(0,t.jsx)("span",{className:"absolute left-full top-1/2 -translate-y-1/2 ml-3 text-[0.65rem] font-bold uppercase tracking-wide px-2 py-1 rounded-md text-white animate-pop whitespace-nowrap",style:{background:a.color},children:"Start"}),(0,t.jsx)(o.default,{href:`/lesson/${n.id}`,"aria-label":`${n.title}${r?" (done)":""}`,className:`node-shadow flex items-center justify-center w-16 h-16 rounded-full transition-transform ${r||i?"text-white":"bg-surface-2 text-muted border border-border"} ${i?"ring-4 ring-offset-2 ring-offset-bg":""}`,style:{background:r||i?a.color:void 0,"--tw-ring-color":`${a.color}55`,"--node-shadow":r||i?"rgba(0,0,0,0.25)":"var(--border)"},children:r?(0,t.jsx)(h,{}):(0,t.jsx)("span",{className:"text-lg font-semibold",children:s+1})}),(0,t.jsx)("p",{className:"absolute top-full left-1/2 -translate-x-1/2 mt-1.5 w-36 text-center text-[0.7rem] text-muted leading-tight line-clamp-2",children:n.title})]},n.id)}),(0,t.jsxs)("li",{className:"relative",style:{transform:`translateX(${d[a.lessons.length%d.length]}px)`},children:[(0,t.jsx)(o.default,{href:E,"aria-label":`Lab: unit ${a.number}`,className:`node-shadow flex items-center justify-center w-16 h-16 rounded-2xl border-2 transition-transform ${i.labDone>0&&i.labDone===i.labTotal?"text-white":"bg-surface text-fg"}`,style:{borderColor:a.color,background:i.labDone>0&&i.labDone===i.labTotal?a.color:void 0,"--node-shadow":`${a.color}66`},children:i.labDone>0&&i.labDone===i.labTotal?(0,t.jsx)(c,{}):(0,t.jsx)(u,{})}),(0,t.jsxs)("p",{className:"absolute top-full left-1/2 -translate-x-1/2 mt-1.5 w-36 text-center text-[0.7rem] text-muted leading-tight line-clamp-2",children:["Lab",m?` \xb7 ${i.labDone}/${i.labTotal}`:""]})]})]})]},a.number)})]})}])},26033,e=>{"use strict";let t=[{slug:"py0-count-rows",chapter:0,title:"How many deals are there?",difficulty:"warmup",prompt:"`deals` is a DataFrame. Set `result` to the number of rows in it.",starterCode:"result = None  # TODO: len(...)",solution:"result = len(deals)",dpmConnection:{text:"len() on a DataFrame is COUNT(*). Knowing the row count is the sanity check before any other number.",kbSlug:"python-pandas-101"},hint:"len(deals)"},{slug:"py0-filter-sum",chapter:0,title:"Total amount of qualified deals",difficulty:"warmup",prompt:'Keep the rows where `stage == "qualified"`, then set `result` to the sum of their `amount`.',starterCode:`qualified = deals[deals["stage"] == "qualified"]
...
ORDER BY c.month;`,solution:"WITH rev AS (SELECT substr(transaction_date, 1, 7) AS month, SUM(amount) AS revenue_generated FROM transactions GROUP BY month), closed AS (SELECT substr(closed_date, 1, 7) AS month, SUM(CASE WHEN stage = 'closed_won' THEN amount ELSE 0 END) AS deals_closed_value, ROUND(1.0 * SUM(stage = 'closed_won') / COUNT(*), 4) AS conversion_rate FROM deals WHERE closed_date IS NOT NULL AND stage IN ('closed_won', 'closed_lost') GROUP BY month) SELECT c.month, COALESCE(r.revenue_generated, 0) AS revenue_generated, c.deals_closed_value, c.conversion_rate FROM closed c LEFT JOIN rev r ON r.month = c.month WHERE c.month IN ('2026-06', '2026-07', '2026-08') ORDER BY c.month;",orderMatters:!0,dpmConnection:{text:"North Star, functional, granular: one definition each, one query, one owner. Six weeks ago these were three arguments. Now they are a semantic contract that a dashboard, a finance analyst, and an AI agent can all read the same way.",kbSlug:"metric-types"},hint:"The starter is complete. Notice conversion here is by *closed* month, not created cohort: a different, equally valid cut. Name it accordingly on the tree."}];e.s(["sqlExercises",0,o,"sqlExercisesForChapter",0,function(e){return o.filter(t=>t.chapter===e)}])},79922,e=>{"use strict";var t=e.i(6e4),o=e.i(8908),a=e.i(26033);function n(e,n){let s=t.units.find(e=>e.number===n),r=s.lessons.filter(t=>e.lessons[t.id]),i=[...(0,o.sqlExercisesForChapter)(n),...(0,a.pythonExercisesForChapter)(n)],l=i.filter(t=>e.exercises[t.slug]?.status==="solved").length,d=s.lessons.find(t=>!e.lessons[t.id]);return{number:n,lessonsTotal:s.lessons.length,lessonsDone:r.length,labTotal:i.length,labDone:l,fraction:s.lessons.length?r.length/s.lessons.length:0,complete:s.lessons.length>0&&r.length===s.lessons.length,nextLessonId:d?.id??null}}function s(e){return t.units.map(t=>n(e,t.number))}e.s(["allUnitProgress",0,s,"nextLesson",0,function(e){return t.allLessons.find(t=>!e.lessons[t.id])??null},"totals",0,function(e){let t=s(e);return{lessonsDone:t.reduce((e,t)=>e+t.lessonsDone,0),lessonsTotal:t.reduce((e,t)=>e+t.lessonsTotal,0),labsDone:t.reduce((e,t)=>e+t.labDone,0),labsTotal:t.reduce((e,t)=>e+t.labTotal,0)}},"unitProgress",0,n])},74581,e=>{"use strict";var t=e.i(71645);function o(e=new Date){let t=e.getFullYear(),a=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0");return`${t}-${a}-${n}`}let a="dpm-lab:progress:v1";function n(){return{version:1,user_id:"local",exercises:{},attempts:[],srs:{},lessons:{},streak:{current:0,lastActiveDate:null}}}function s(){try{let e=window.localStorage.getItem(a);if(!e)return n();let t=JSON.parse(e);if(t?.version!==1)return n();return{...n(),...t}}catch{return n()}}function r(e){let t,a=o(),{current:n,lastActiveDate:s}=e.streak;if(s===a)return e;let r=s===((t=new Date).setDate(t.getDate()-1),o(t))?n+1:1;return{...e,streak:{current:r,lastActiveDate:a}}}let i=n(),l=null,d=new Set;function c(){return null===l&&(l=s()),l}function u(){return i}function h(){for(let e of d)e()}function m(e){d.add(e);let t=e=>{e.key===a&&(l=s(),h())};return window.addEventListener("storage",t),()=>{d.delete(e),window.removeEventListener("storage",t)}}e.s(["dueCards",0,function(e,t){return t.filter(t=>(function(e,t=new Date){return!e||e.due<=o(t)})(e.srs[t.id]))},"useProgress",0,function(){let e=(0,t.useSyncExternalStore)(m,c,u),s=(0,t.useCallback)(e=>{var t=e(c());l=t;try{window.localStorage.setItem(a,JSON.stringify(t))}catch{}h()},[]),d=(0,t.useCallback)((e,t,o,a)=>s(n=>{let s,i,l,d,c;return s=new Date().toISOString(),i=n.exercises[e]??{kind:t,status:"not_started",attempts:0},l=a||"solved"===i.status?"solved":"attempted",d={...n.exercises,[e]:{...i,kind:t,status:l,attempts:i.attempts+1,lastAttemptAt:s,solvedAt:a&&!i.solvedAt?s:i.solvedAt}},c=[{id:`${e}:${s}`,slug:e,kind:t,code:o,passed:a,at:s},...n.attempts].slice(0,200),r({...n,exercises:d,attempts:c})}),[s]),g=(0,t.useCallback)((e,t)=>s(a=>{let n;return n=a.srs[e]??function(e=new Date){return{ease:2.5,interval:0,repetitions:0,due:o(e)}}(),r({...a,srs:{...a.srs,[e]:function(e,t,a=new Date){let{ease:n,interval:s,repetitions:r}=e;return t<3?(r=0,s=1):(s=0===r?1:1===r?6:Math.round(s*n),r+=1),(n+=.1-(5-t)*(.08+(5-t)*.02))<1.3&&(n=1.3),{ease:Math.round(100*n)/100,interval:s,repetitions:r,due:function(e,t){let[a,n,s]=e.split("-").map(Number),r=new Date(a,n-1,s);return r.setDate(r.getDate()+t),o(r)}(o(a),s)}}(n,t)}})}),[s]);return{data:e,hydrated:e!==i,recordAttempt:d,recordReview:g,recordLessonComplete:(0,t.useCallback)((e,t)=>s(o=>{let a,n;return a=o.lessons[e],n=Math.max(a?.bestAccuracy??0,t),r({...o,lessons:{...o.lessons,[e]:{completedAt:new Date().toISOString(),completions:(a?.completions??0)+1,bestAccuracy:n,perfect:n>=1}}})}),[s]),reset:(0,t.useCallback)(()=>s(()=>n()),[s])}}],74581)},7664,e=>{"use strict";let t=["Newcomer","Question asker","Metric mapper","Data auditor","Launch lead","Root-cause finder","Definition owner","Data Product Manager"];e.s(["XP_LAB_EXERCISE",0,20,"XP_LESSON",0,10,"XP_PERFECT_BONUS",0,5,"computeXp",0,function(e){let t=0;for(let o of Object.values(e.lessons))t+=10+5*!!o.perfect;let o=0;for(let t of Object.values(e.exercises))"solved"===t.status&&(o+=20);return{total:t+o,fromLessons:t,fromLabs:o}},"levelFor",0,function(e){let t=Math.floor(e/100)+1,o=e%100;return{level:t,intoLevel:o,toNext:100-o,fraction:o/100}},"levelTitle",0,function(e){return t[Math.min(e-1,t.length-1)]}])}]);