(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,52758,e=>{"use strict";var t=e.i(18050),a=e.i(22016),s=e.i(18566),n=e.i(71645),r=e.i(21683);function o(e,t){let a=[...e],s=function(e){let t=0x811c9dc5;for(let a=0;a<e.length;a++)t^=e.charCodeAt(a),t=Math.imul(t,0x1000193);return t>>>0}(t)||1,n=()=>{let e=s=s+0x6d2b79f5>>>0;return e=Math.imul(e^e>>>15,1|e),(((e^=e+Math.imul(e^e>>>7,61|e))^e>>>14)>>>0)/0x100000000};for(let e=a.length-1;e>0;e--){let t=Math.floor(n()*(e+1));[a[e],a[t]]=[a[t],a[e]]}return a}function i(e){switch(e.kind){case"mcq":return{kind:"mcq",choice:null};case"truefalse":return{kind:"truefalse",choice:null};case"fill":return{kind:"fill",word:null};case"order":return{kind:"order",sequence:[]};case"match":return{kind:"match",matched:new Set,selectedLeft:null,selectedRight:null,mistakes:0};default:return{kind:"concept"}}}function l(e,t){switch(e.kind){case"mcq":return"mcq"===t.kind&&null!==t.choice;case"truefalse":return"truefalse"===t.kind&&null!==t.choice;case"fill":return"fill"===t.kind&&null!==t.word;case"order":return"order"===t.kind&&t.sequence.length===e.steps.length;case"match":return"match"===t.kind&&t.matched.size===e.pairs.length;default:return!0}}function c(e){return o(e.steps.map((e,t)=>t),e.id)}function d(e){switch(e.kind){case"mcq":return e.options[e.correct];case"truefalse":return e.answer?"True":"False";case"fill":return e.answer;case"order":return e.steps.map((e,t)=>`${t+1}. ${e}`).join("  ");default:return null}}let u="w-full text-left rounded-xl border-2 px-4 py-3 text-[0.95rem] transition-colors disabled:cursor-default",m="border-border bg-surface hover:border-accent",h="border-accent bg-accent-soft",p="border-success bg-success-soft",g="border-danger bg-danger-soft";function f({item:e}){return(0,t.jsxs)("div",{className:"animate-pop",children:[(0,t.jsx)("p",{className:"text-xs uppercase tracking-wide text-accent font-semibold mb-2",children:"Concept"}),(0,t.jsx)("h2",{className:"text-2xl font-semibold tracking-tight mb-3",children:e.title}),(0,t.jsx)(r.Markdown,{className:"text-[1.02rem]",children:e.body})]})}function y({item:e,answer:a,setAnswer:s,locked:n}){let o="mcq"===a.kind?a.choice:null;return(0,t.jsxs)("div",{className:"space-y-4 animate-pop",children:[(0,t.jsx)(r.Markdown,{className:"text-[1.02rem]",children:e.prompt}),(0,t.jsx)("ol",{className:"space-y-2",children:e.options.map((a,r)=>{let i=m;return n?i=r===e.correct?p:r===o?g:"border-border opacity-60":o===r&&(i=h),(0,t.jsx)("li",{children:(0,t.jsxs)("button",{disabled:n,onClick:()=>s({kind:"mcq",choice:r}),className:`${u} ${i}`,children:[(0,t.jsx)("span",{className:"font-mono text-muted mr-3",children:String.fromCharCode(65+r)}),a]})},r)})})]})}function b({item:e,answer:a,setAnswer:s,locked:n}){let r="truefalse"===a.kind?a.choice:null;return(0,t.jsxs)("div",{className:"space-y-5 animate-pop",children:[(0,t.jsx)("p",{className:"text-xs uppercase tracking-wide text-muted",children:"True or false?"}),(0,t.jsx)("p",{className:"text-xl font-medium leading-snug",children:e.statement}),(0,t.jsx)("div",{className:"grid grid-cols-2 gap-3",children:[!0,!1].map(a=>{let o=m;return n?o=a===e.answer?p:a===r?g:"border-border opacity-60":r===a&&(o=h),(0,t.jsx)("button",{disabled:n,onClick:()=>s({kind:"truefalse",choice:a}),className:`${u} text-center font-semibold py-4 ${o}`,children:a?"True":"False"},String(a))})})]})}function w({item:e,answer:a,setAnswer:s,locked:r}){let i="fill"===a.kind?a.word:null,l=(0,n.useMemo)(()=>o(e.bank,e.id),[e]),[c,d]=e.prompt.split("___");return(0,t.jsxs)("div",{className:"space-y-5 animate-pop",children:[(0,t.jsx)("p",{className:"text-xs uppercase tracking-wide text-muted",children:"Fill the blank"}),(0,t.jsxs)("p",{className:"text-xl leading-relaxed",children:[c,(0,t.jsx)("span",{className:`inline-block min-w-[6rem] border-b-2 px-2 mx-1 text-center font-semibold ${r?i===e.answer?"border-success text-success":"border-danger text-danger":i?"border-accent text-accent":"border-border"}`,children:i??" "}),d]}),(0,t.jsx)("div",{className:"flex flex-wrap gap-2",children:l.map(a=>{let n=i===a,o="border-border bg-surface hover:border-accent";return r?o=a===e.answer?p:n?g:"border-border opacity-60":n&&(o="border-accent bg-accent-soft"),(0,t.jsx)("button",{disabled:r,onClick:()=>s({kind:"fill",word:n?null:a}),className:`rounded-xl border-2 px-4 py-2.5 text-[0.95rem] font-medium transition-colors ${o}`,children:a},a)})})]})}function x({item:e,answer:a,setAnswer:s,locked:r}){let o=(0,n.useMemo)(()=>c(e),[e]),i="order"===a.kind?a.sequence:[],l=o.map((e,t)=>t).filter(e=>!i.includes(e));return(0,t.jsxs)("div",{className:"space-y-5 animate-pop",children:[(0,t.jsx)("p",{className:"text-xs uppercase tracking-wide text-muted",children:"Put in order"}),(0,t.jsx)("p",{className:"text-lg font-medium leading-snug",children:e.prompt}),(0,t.jsxs)("ol",{className:"space-y-2 min-h-[3rem]",children:[i.map((a,n)=>{let l=o[a];return(0,t.jsx)("li",{children:(0,t.jsxs)("button",{disabled:r,onClick:()=>s({kind:"order",sequence:i.filter(e=>e!==a)}),className:`${u} flex gap-3 ${r?l===n?p:g:h}`,children:[(0,t.jsxs)("span",{className:"font-mono text-muted",children:[n+1,"."]}),(0,t.jsx)("span",{children:e.steps[l]})]})},a)}),0===i.length&&(0,t.jsx)("li",{className:"text-sm text-muted px-1",children:"Tap the steps below in the right order."})]}),(0,t.jsx)("div",{className:"flex flex-wrap gap-2",children:l.map(a=>(0,t.jsx)("button",{disabled:r,onClick:()=>s({kind:"order",sequence:[...i,a]}),className:"rounded-xl border-2 border-border bg-surface hover:border-accent px-4 py-2.5 text-[0.95rem] text-left transition-colors",children:e.steps[o[a]]},a))})]})}function v({item:e,answer:a,setAnswer:s,locked:r}){let i="match"===a.kind?a:{kind:"match",matched:new Set,selectedLeft:null,selectedRight:null,mistakes:0},l=(0,n.useMemo)(()=>o(e.pairs.map((e,t)=>t),e.id),[e]),c=(e,a,n)=>{let o=i.matched.has(e),l="left"===a?i.selectedLeft===e:i.selectedRight===e,c="border-border bg-surface hover:border-accent";return o?c="border-success bg-success-soft opacity-80":l&&(c="border-accent bg-accent-soft"),(0,t.jsx)("button",{disabled:r||o,onClick:()=>((e,t)=>{if(r||i.matched.has(t)&&"left"===e)return;let a={...i,matched:new Set(i.matched)};"left"===e?a.selectedLeft=i.selectedLeft===t?null:t:a.selectedRight=i.selectedRight===t?null:t,null!==a.selectedLeft&&null!==a.selectedRight&&(a.selectedLeft===a.selectedRight?a.matched.add(a.selectedLeft):a.mistakes+=1,a.selectedLeft=null,a.selectedRight=null),s(a)})(a,e),className:`w-full min-h-[3.25rem] rounded-xl border-2 px-3 py-2 text-sm text-left transition-colors ${c}`,children:n},`${a}-${e}`)};return(0,t.jsxs)("div",{className:"space-y-4 animate-pop",children:[(0,t.jsx)("p",{className:"text-xs uppercase tracking-wide text-muted",children:"Match the pairs"}),(0,t.jsx)("p",{className:"text-lg font-medium leading-snug",children:e.prompt}),(0,t.jsxs)("div",{className:"grid grid-cols-2 gap-2",children:[(0,t.jsx)("div",{className:"space-y-2",children:e.pairs.map((e,t)=>c(t,"left",e[0]))}),(0,t.jsx)("div",{className:"space-y-2",children:l.map(t=>c(t,"right",e.pairs[t][1]))})]}),i.mistakes>0&&!r&&(0,t.jsxs)("p",{className:"text-xs text-danger",children:["Not that pair. ",i.mistakes," miss",1===i.mistakes?"":"es"," so far."]})]})}function k(e){let{item:a}=e;switch(a.kind){case"concept":return(0,t.jsx)(f,{item:a});case"mcq":return(0,t.jsx)(y,{...e,item:a});case"truefalse":return(0,t.jsx)(b,{...e,item:a});case"fill":return(0,t.jsx)(w,{...e,item:a});case"order":return(0,t.jsx)(x,{...e,item:a});case"match":return(0,t.jsx)(v,{...e,item:a})}}var N=e.i(6e4),S=e.i(82364),P=e.i(74581),j=e.i(7664);let A={mcq:"Choose one",truefalse:"True or false",fill:"Fill the blank",match:"Match",order:"Order"};function D(e){return{queue:e.items.map((e,t)=>t),pos:0,answer:i(e.items[0]),phase:"answer",hearts:3,lastCorrect:!1,firstTry:{},requeued:new Set,missed:[]}}function E({full:e}){return(0,t.jsx)("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:e?"currentColor":"none",stroke:"currentColor",strokeWidth:"2","aria-hidden":!0,className:e?"text-danger":"text-border",children:(0,t.jsx)("path",{d:"M12 21s-7-4.6-9.3-8.6C.8 9.1 2.6 5 6.5 5c2.1 0 3.4 1.2 4.1 2.2h2.8C14.1 6.2 15.4 5 17.5 5c3.9 0 5.7 4.1 3.8 7.4C19 16.4 12 21 12 21z"})})}e.s(["LessonPlayer",0,function({lesson:e}){let r=(0,s.useRouter)(),{recordLessonComplete:o}=(0,P.useProgress)(),[u,m]=(0,n.useState)(()=>D(e)),h=N.units.find(t=>t.number===e.unit),p=u.queue[u.pos],g=e.items[p],f=e.items.filter(e=>"concept"!==e.kind).length,y=Object.keys(u.firstTry).length,b=e.items.length?(u.pos+ +("feedback"===u.phase))/u.queue.length:0,w=(0,n.useMemo)(()=>{let e=Object.values(u.firstTry);return e.length?e.filter(Boolean).length/e.length:1},[u.firstTry]),x=t=>{m(a=>{let s=a.queue,n=a.requeued;t||a.requeued.has(p)||(s=[...a.queue,p],(n=new Set(a.requeued)).add(p));let r=a.pos+1;return r>=s.length?{...a,queue:s,requeued:n,phase:"complete"}:{...a,queue:s,requeued:n,pos:r,answer:i(e.items[s[r]]),phase:"answer"}})},v=()=>{if(!g)return;if("concept"===g.kind)return void x(!0);let e=function(e,t){switch(e.kind){case"mcq":return"mcq"===t.kind&&t.choice===e.correct;case"truefalse":return"truefalse"===t.kind&&t.choice===e.answer;case"fill":return"fill"===t.kind&&t.word===e.answer;case"order":{if("order"!==t.kind)return!1;let a=c(e);return t.sequence.every((e,t)=>a[e]===t)}case"match":return"match"===t.kind&&0===t.mistakes;default:return!0}}(g,u.answer);m(t=>{let a=void 0===t.firstTry[p]?{...t.firstTry,[p]:e}:t.firstTry,s=e?t.hearts:t.hearts-1,n=e||t.missed.includes(p)?t.missed:[...t.missed,p];return{...t,phase:s<=0?"failed":"feedback",lastCorrect:e,hearts:s,firstTry:a,missed:n}})};if((0,n.useEffect)(()=>{"complete"===u.phase&&o(e.id,w)},[u.phase,e.id,w,o]),(0,n.useEffect)(()=>{let e=e=>{"Enter"===e.key&&("answer"===u.phase&&g&&l(g,u.answer)?v():"feedback"===u.phase&&x(u.lastCorrect))};return window.addEventListener("keydown",e),()=>window.removeEventListener("keydown",e)}),"complete"===u.phase){let a=w>=1,s=j.XP_LESSON+(a?j.XP_PERFECT_BONUS:0);return(0,t.jsxs)("div",{className:"flex-1 flex flex-col items-center justify-center text-center px-6 py-10 gap-4 animate-pop",children:[(0,t.jsx)("div",{className:"w-24 h-24 rounded-full flex items-center justify-center text-white text-4xl",style:{background:h.color},children:a?"★":"✓"}),(0,t.jsx)("h1",{className:"text-2xl font-semibold tracking-tight",children:a?"Perfect lesson":"Lesson complete"}),(0,t.jsx)("p",{className:"text-muted",children:e.title}),(0,t.jsxs)("div",{className:"grid grid-cols-2 gap-3 w-full max-w-xs mt-2",children:[(0,t.jsxs)("div",{className:"rounded-xl border border-border bg-surface p-3",children:[(0,t.jsx)("p",{className:"text-xs uppercase tracking-wide text-muted",children:"XP earned"}),(0,t.jsxs)("p",{className:"text-2xl font-semibold tabular-nums text-accent",children:["+",s]})]}),(0,t.jsxs)("div",{className:"rounded-xl border border-border bg-surface p-3",children:[(0,t.jsx)("p",{className:"text-xs uppercase tracking-wide text-muted",children:"Accuracy"}),(0,t.jsxs)("p",{className:"text-2xl font-semibold tabular-nums",children:[Math.round(100*w),"%"]})]})]}),(0,t.jsx)("button",{onClick:()=>r.push("/"),className:"mt-4 w-full max-w-xs px-5 py-3.5 rounded-xl font-semibold text-white node-shadow",style:{background:h.color},children:"Continue"})]})}if("failed"===u.phase)return(0,t.jsxs)("div",{className:"flex-1 flex flex-col px-5 py-8 gap-4 max-w-xl mx-auto w-full animate-pop",children:[(0,t.jsxs)("div",{className:"text-center space-y-2",children:[(0,t.jsx)("div",{className:"flex justify-center gap-1",children:Array.from({length:3}).map((e,a)=>(0,t.jsx)(E,{full:!1},a))}),(0,t.jsx)("h1",{className:"text-2xl font-semibold tracking-tight",children:"Out of hearts"}),(0,t.jsx)("p",{className:"text-muted",children:"Review what you missed, then try again. No XP this round."})]}),(0,t.jsx)("ul",{className:"space-y-3",children:u.missed.map(a=>{let s=e.items[a];if("concept"===s.kind)return null;let n=d(s);return(0,t.jsxs)("li",{className:"rounded-xl border border-border bg-surface p-4 text-sm space-y-1",children:[(0,t.jsx)("p",{className:"text-xs uppercase tracking-wide text-muted",children:"truefalse"===s.kind?"True or false":s.kind}),n&&(0,t.jsxs)("p",{children:[(0,t.jsx)("span",{className:"font-semibold",children:"Answer:"})," ",n]}),(0,t.jsx)("p",{className:"text-muted",children:s.explanation})]},a)})}),(0,t.jsxs)("div",{className:"grid grid-cols-2 gap-3 mt-auto",children:[(0,t.jsx)(a.default,{href:"/",className:"px-4 py-3 rounded-xl border-2 border-border text-center font-semibold",children:"Back"}),(0,t.jsx)("button",{onClick:()=>m(D(e)),className:"px-4 py-3 rounded-xl font-semibold text-white node-shadow",style:{background:h.color},children:"Try again"})]})]});if(!g)return null;let M="feedback"===u.phase,T=g.kbSlug?(0,S.getKbEntry)(g.kbSlug):void 0,C=d(g),O="mcq"!==g.kind||"mcq"!==u.answer.kind||null===u.answer.choice||u.lastCorrect?void 0:g.optionNotes?.[u.answer.choice];return(0,t.jsxs)("div",{className:"flex-1 flex flex-col",children:[(0,t.jsxs)("div",{className:"px-4 pt-4 pb-2 flex items-center gap-3 max-w-2xl w-full mx-auto",children:[(0,t.jsx)(a.default,{href:"/","aria-label":"Quit lesson",className:"text-muted hover:text-fg text-2xl leading-none px-1",children:"×"}),(0,t.jsx)("div",{className:"flex-1 h-3 rounded-full bg-border overflow-hidden",children:(0,t.jsx)("div",{className:"h-full rounded-full transition-all duration-300",style:{width:`${Math.round(100*b)}%`,background:h.color}})}),(0,t.jsx)("div",{className:"flex gap-0.5","aria-label":`${u.hearts} hearts left`,children:Array.from({length:3}).map((e,a)=>(0,t.jsx)(E,{full:a<u.hearts},a))})]}),(0,t.jsxs)("div",{className:"max-w-2xl w-full mx-auto px-5 flex items-center justify-between text-[0.7rem] uppercase tracking-wide text-muted",children:[(0,t.jsx)("span",{className:"truncate",children:e.title}),(0,t.jsxs)("span",{className:"shrink-0 tabular-nums",children:["concept"===g.kind?"Concept":`${A[g.kind]} \xb7 ${Math.min(y+1,f)} of ${f}`,u.requeued.has(p)&&u.pos>=e.items.length?" · again":""]})]}),(0,t.jsx)("div",{className:"flex-1 px-5 py-6 max-w-2xl w-full mx-auto",children:(0,t.jsx)(k,{item:g,answer:u.answer,setAnswer:e=>m(t=>({...t,answer:e})),locked:M})}),(0,t.jsx)("div",{className:`border-t safe-bottom pt-4 ${M?u.lastCorrect?"bg-success-soft border-success/30":"bg-danger-soft border-danger/30":"bg-surface border-border"}`,children:(0,t.jsxs)("div",{className:"max-w-2xl w-full mx-auto px-5 space-y-3",children:[M&&(0,t.jsxs)("div",{className:`animate-slide-up ${u.lastCorrect?"text-success":"text-danger"}`,children:[(0,t.jsxs)("p",{className:"font-semibold text-lg flex items-center gap-2",children:[(0,t.jsx)("span",{className:`w-6 h-6 rounded-full flex items-center justify-center text-sm text-white ${u.lastCorrect?"bg-success":"bg-danger"}`,children:u.lastCorrect?"✓":"✕"}),u.lastCorrect?"Correct!":"Not quite"]}),!u.lastCorrect&&C&&(0,t.jsxs)("p",{className:"text-sm",children:[(0,t.jsx)("span",{className:"font-semibold",children:"Answer:"})," ",C]}),O&&(0,t.jsx)("p",{className:"text-sm mt-1",children:O}),(0,t.jsx)("p",{className:"text-sm mt-1 text-fg/80",children:"concept"!==g.kind?g.explanation:""}),T&&(0,t.jsxs)(a.default,{href:`/kb/${T.slug}`,className:"text-xs underline underline-offset-2 mt-1 inline-block",children:["Read: ",T.title]})]}),M?(0,t.jsx)("button",{onClick:()=>x(u.lastCorrect),className:`w-full px-5 py-3.5 rounded-xl font-semibold text-white node-shadow ${u.lastCorrect?"bg-success":"bg-danger"}`,children:"Continue"}):(0,t.jsx)("button",{onClick:v,disabled:!l(g,u.answer),className:"w-full px-5 py-3.5 rounded-xl font-semibold text-white disabled:opacity-40 node-shadow",style:{background:h.color},children:"concept"===g.kind?"Continue":"Check"}),(0,t.jsxs)("p",{className:"text-center text-[0.7rem] text-muted",children:[y,"/",f," answered · Enter to ",M?"continue":"check"]})]})})]})}],52758)},87110,e=>{"use strict";let t=[{slug:"what-is-a-data-product-manager",title:"What is a Data Product Manager?",category:"definition",tags:["role","fundamentals"],summary:"A DPM sits at the intersection of data, technology, and business, managing data warehouses, platforms, pipelines, and ML models the way a PM manages a product.",body:`A **Data Product Manager (DPM)** is a specialized role at the intersection of
...
**source-aligned** product if it had a contract and an owner.`,source:"Modern Data 101 (Defining the True Data Product; Anatomy; Canonical Core; product types), from the user's notes."}];e.s(["kbEntries",0,t])},82364,76091,e=>{"use strict";var t=e.i(87110);function a(e){return e.startsWith("/")?`/dpm-lab${e}`:e}e.s(["withBasePath",0,a],76091);let s=new Map(t.kbEntries.map(e=>[e.slug,e]));e.s(["CATEGORY_LABELS",0,{framework:"Framework",definition:"Definition","case-study":"Case study","industry-context":"Industry context"},"getKbEntry",0,function(e){return s.get(e)},"resolveWikiLinks",0,function(e){return e.replace(/\[\[([a-z0-9-]+)\]\]/g,(e,t)=>{let n=s.get(t);return n?`[${n.title}](${a(`/kb/${t}`)})`:`\`${t}\``})}],82364)},74581,e=>{"use strict";var t=e.i(71645);function a(e=new Date){let t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0");return`${t}-${s}-${n}`}let s="dpm-lab:progress:v1";function n(){return{version:1,user_id:"local",exercises:{},attempts:[],srs:{},lessons:{},streak:{current:0,lastActiveDate:null}}}function r(){try{let e=window.localStorage.getItem(s);if(!e)return n();let t=JSON.parse(e);if(t?.version!==1)return n();return{...n(),...t}}catch{return n()}}function o(e){let t,s=a(),{current:n,lastActiveDate:r}=e.streak;if(r===s)return e;let o=r===((t=new Date).setDate(t.getDate()-1),a(t))?n+1:1;return{...e,streak:{current:o,lastActiveDate:s}}}let i=n(),l=null,c=new Set;function d(){return null===l&&(l=r()),l}function u(){return i}function m(){for(let e of c)e()}function h(e){c.add(e);let t=e=>{e.key===s&&(l=r(),m())};return window.addEventListener("storage",t),()=>{c.delete(e),window.removeEventListener("storage",t)}}e.s(["dueCards",0,function(e,t){return t.filter(t=>(function(e,t=new Date){return!e||e.due<=a(t)})(e.srs[t.id]))},"useProgress",0,function(){let e=(0,t.useSyncExternalStore)(h,d,u),r=(0,t.useCallback)(e=>{var t=e(d());l=t;try{window.localStorage.setItem(s,JSON.stringify(t))}catch{}m()},[]),c=(0,t.useCallback)((e,t,a,s)=>r(n=>{let r,i,l,c,d;return r=new Date().toISOString(),i=n.exercises[e]??{kind:t,status:"not_started",attempts:0},l=s||"solved"===i.status?"solved":"attempted",c={...n.exercises,[e]:{...i,kind:t,status:l,attempts:i.attempts+1,lastAttemptAt:r,solvedAt:s&&!i.solvedAt?r:i.solvedAt}},d=[{id:`${e}:${r}`,slug:e,kind:t,code:a,passed:s,at:r},...n.attempts].slice(0,200),o({...n,exercises:c,attempts:d})}),[r]),p=(0,t.useCallback)((e,t)=>r(s=>{let n;return n=s.srs[e]??function(e=new Date){return{ease:2.5,interval:0,repetitions:0,due:a(e)}}(),o({...s,srs:{...s.srs,[e]:function(e,t,s=new Date){let{ease:n,interval:r,repetitions:o}=e;return t<3?(o=0,r=1):(r=0===o?1:1===o?6:Math.round(r*n),o+=1),(n+=.1-(5-t)*(.08+(5-t)*.02))<1.3&&(n=1.3),{ease:Math.round(100*n)/100,interval:r,repetitions:o,due:function(e,t){let[s,n,r]=e.split("-").map(Number),o=new Date(s,n-1,r);return o.setDate(o.getDate()+t),a(o)}(a(s),r)}}(n,t)}})}),[r]);return{data:e,hydrated:e!==i,recordAttempt:c,recordReview:p,recordLessonComplete:(0,t.useCallback)((e,t)=>r(a=>{let s,n;return s=a.lessons[e],n=Math.max(s?.bestAccuracy??0,t),o({...a,lessons:{...a.lessons,[e]:{completedAt:new Date().toISOString(),completions:(s?.completions??0)+1,bestAccuracy:n,perfect:n>=1}}})}),[r]),reset:(0,t.useCallback)(()=>r(()=>n()),[r])}}],74581)},7664,e=>{"use strict";let t=["Newcomer","Question asker","Metric mapper","Data auditor","Launch lead","Root-cause finder","Definition owner","Data Product Manager"];e.s(["XP_LAB_EXERCISE",0,20,"XP_LESSON",0,10,"XP_PERFECT_BONUS",0,5,"computeXp",0,function(e){let t=0;for(let a of Object.values(e.lessons))t+=10+5*!!a.perfect;let a=0;for(let t of Object.values(e.exercises))"solved"===t.status&&(a+=20);return{total:t+a,fromLessons:t,fromLabs:a}},"levelFor",0,function(e){let t=Math.floor(e/100)+1,a=e%100;return{level:t,intoLevel:a,toNext:100-a,fraction:a/100}},"levelTitle",0,function(e){return t[Math.min(e-1,t.length-1)]}])}]);