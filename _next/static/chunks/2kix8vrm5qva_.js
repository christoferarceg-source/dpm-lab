...
**source-aligned** product if it had a contract and an owner.`,source:"Modern Data 101 (Defining the True Data Product; Anatomy; Canonical Core; product types), from the user's notes."}];e.s(["kbEntries",0,t])},82364,76091,e=>{"use strict";var t=e.i(87110);function a(e){return e.startsWith("/")?`/dpm-lab${e}`:e}e.s(["withBasePath",0,a],76091);let s=new Map(t.kbEntries.map(e=>[e.slug,e]));e.s(["CATEGORY_LABELS",0,{framework:"Framework",definition:"Definition","case-study":"Case study","industry-context":"Industry context"},"getKbEntry",0,function(e){return s.get(e)},"resolveWikiLinks",0,function(e){return e.replace(/\[\[([a-z0-9-]+)\]\]/g,(e,t)=>{let n=s.get(t);return n?`[${n.title}](${a(`/kb/${t}`)})`:`\`${t}\``})}],82364)},74581,e=>{"use strict";var t=e.i(71645);function a(e=new Date){let t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0");return`${t}-${s}-${n}`}let s="dpm-lab:progress:v1";function n(){return{version:1,user_id:"local",exercises:{},attempts:[],srs:{},lessons:{},streak:{current:0,lastActiveDate:null}}}function o(){try{let e=window.localStorage.getItem(s);if(!e)return n();let t=JSON.parse(e);if(t?.version!==1)return n();return{...n(),...t}}catch{return n()}}function i(e){let t,s=a(),{current:n,lastActiveDate:o}=e.streak;if(o===s)return e;let i=o===((t=new Date).setDate(t.getDate()-1),a(t))?n+1:1;return{...e,streak:{current:i,lastActiveDate:s}}}let r=n(),l=null,d=new Set;function c(){return null===l&&(l=o()),l}function u(){return r}function h(){for(let e of d)e()}function m(e){d.add(e);let t=e=>{e.key===s&&(l=o(),h())};return window.addEventListener("storage",t),()=>{d.delete(e),window.removeEventListener("storage",t)}}e.s(["dueCards",0,function(e,t){return t.filter(t=>(function(e,t=new Date){return!e||e.due<=a(t)})(e.srs[t.id]))},"useProgress",0,function(){let e=(0,t.useSyncExternalStore)(m,c,u),o=(0,t.useCallback)(e=>{var t=e(c());l=t;try{window.localStorage.setItem(s,JSON.stringify(t))}catch{}h()},[]),d=(0,t.useCallback)((e,t,a,s)=>o(n=>{let o,r,l,d,c;return o=new Date().toISOString(),r=n.exercises[e]??{kind:t,status:"not_started",attempts:0},l=s||"solved"===r.status?"solved":"attempted",d={...n.exercises,[e]:{...r,kind:t,status:l,attempts:r.attempts+1,lastAttemptAt:o,solvedAt:s&&!r.solvedAt?o:r.solvedAt}},c=[{id:`${e}:${o}`,slug:e,kind:t,code:a,passed:s,at:o},...n.attempts].slice(0,200),i({...n,exercises:d,attempts:c})}),[o]),g=(0,t.useCallback)((e,t)=>o(s=>{let n;return n=s.srs[e]??function(e=new Date){return{ease:2.5,interval:0,repetitions:0,due:a(e)}}(),i({...s,srs:{...s.srs,[e]:function(e,t,s=new Date){let{ease:n,interval:o,repetitions:i}=e;return t<3?(i=0,o=1):(o=0===i?1:1===i?6:Math.round(o*n),i+=1),(n+=.1-(5-t)*(.08+(5-t)*.02))<1.3&&(n=1.3),{ease:Math.round(100*n)/100,interval:o,repetitions:i,due:function(e,t){let[s,n,o]=e.split("-").map(Number),i=new Date(s,n-1,o);return i.setDate(i.getDate()+t),a(i)}(a(s),o)}}(n,t)}})}),[o]);return{data:e,hydrated:e!==r,recordAttempt:d,recordReview:g,recordLessonComplete:(0,t.useCallback)((e,t)=>o(a=>{let s,n;return s=a.lessons[e],n=Math.max(s?.bestAccuracy??0,t),i({...a,lessons:{...a.lessons,[e]:{completedAt:new Date().toISOString(),completions:(s?.completions??0)+1,bestAccuracy:n,perfect:n>=1}}})}),[o]),reset:(0,t.useCallback)(()=>o(()=>n()),[o])}}],74581)}]);