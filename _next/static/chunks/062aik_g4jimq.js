...
**source-aligned** product if it had a contract and an owner.`,source:"Modern Data 101 (Defining the True Data Product; Anatomy; Canonical Core; product types), from the user's notes."}];e.s(["kbEntries",0,t])},82364,76091,e=>{"use strict";var t=e.i(87110);function a(e){return e.startsWith("/")?`/dpm-lab${e}`:e}e.s(["withBasePath",0,a],76091);let s=new Map(t.kbEntries.map(e=>[e.slug,e]));e.s(["getKbEntry",0,function(e){return s.get(e)},"resolveWikiLinks",0,function(e){return e.replace(/\[\[([a-z0-9-]+)\]\]/g,(e,t)=>{let n=s.get(t);return n?`[${n.title}](${a(`/kb/${t}`)})`:`\`${t}\``})}],82364)},7664,e=>{"use strict";let t=["Newcomer","Question asker","Metric mapper","Data auditor","Launch lead","Root-cause finder","Definition owner","Data Product Manager"];e.s(["XP_LAB_EXERCISE",0,20,"XP_LESSON",0,10,"XP_PERFECT_BONUS",0,5,"computeXp",0,function(e){let t=0;for(let a of Object.values(e.lessons))t+=10+5*!!a.perfect;let a=0;for(let t of Object.values(e.exercises))"solved"===t.status&&(a+=20);return{total:t+a,fromLessons:t,fromLabs:a}},"levelFor",0,function(e){let t=Math.floor(e/100)+1,a=e%100;return{level:t,intoLevel:a,toNext:100-a,fraction:a/100}},"levelTitle",0,function(e){return t[Math.min(e-1,t.length-1)]}])}]);