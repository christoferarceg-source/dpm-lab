(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,6159,18994,77475,29187,136,36420,e=>{"use strict";var t=e.i(18050),a=e.i(22016),r=e.i(70703),s=e.i(71645),n=e.i(21683),o=e.i(74581),i=e.i(82364);function l(e){return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)}var d=e.i(47371);let c=(0,r.default)(()=>e.A(91987).then(e=>e.CodeEditor),{loadableGenerated:{modules:[95931]},ssr:!1,loading:()=>(0,t.jsx)("div",{className:"h-[180px] rounded-lg border border-border bg-code-bg animate-pulse"})}),u={warmup:"Warm-up",core:"Core",advanced:"Advanced"},h={warmup:"bg-success-soft text-success",core:"bg-accent-soft text-accent",advanced:"bg-warn-soft text-warn"};function m({status:e}){let a="solved"===e?"Solved":"attempted"===e?"Attempted":"Not started";return(0,t.jsx)("span",{className:`inline-block w-2 h-2 rounded-full shrink-0 ${"solved"===e?"bg-success":"attempted"===e?"bg-warn":"bg-border"}`,title:a,"aria-label":a})}function g({exercise:e,kind:r,ensurePrepared:l,prepStatus:m,run:p,grade:f,renderResult:y}){let{recordAttempt:b}=(0,o.useProgress)(),[w,v]=(0,s.useState)(e.starter),[x,T]=(0,s.useState)(!1),[k,E]=(0,s.useState)(!1),[_,N]=(0,s.useState)(null),[S,P]=(0,s.useState)(null),A=d.chapters.find(t=>t.number===e.chapter),M=(0,s.useCallback)(async t=>{E(!0),P(null);try{await l();let a=await p(w);if(N(a),t)if(a.ok){let t=f(e.slug,a.payload);P(t),b(e.slug,r,w,t.passed)}else P({passed:!1,reason:"Fix the error above, then check again."}),b(e.slug,r,w,!1)}catch(e){N({ok:!1,error:e instanceof Error?e.message:String(e)})}finally{E(!1)}},[w,l,e.slug,f,r,b,p]),L=(0,i.getKbEntry)(e.dpmConnection.kbSlug);return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsxs)("div",{className:"bg-surface border border-border rounded-xl p-5 space-y-4",children:[A&&(0,t.jsxs)(a.default,{href:`/chapters/${A.number}`,className:"text-xs text-muted hover:text-fg",children:[A.week," · ",A.title]}),(0,t.jsxs)("div",{className:"flex flex-wrap items-center gap-2",children:[(0,t.jsx)("h2",{className:"text-lg font-semibold",children:e.title}),(0,t.jsx)("span",{className:`text-xs px-2 py-0.5 rounded-full font-medium ${h[e.difficulty]}`,children:u[e.difficulty]})]}),(0,t.jsx)(n.Markdown,{className:"text-[0.95rem]",children:e.prompt})]}),(0,t.jsxs)("div",{className:"space-y-3",children:[(0,t.jsx)(c,{value:w,onChange:v,language:r}),(0,t.jsxs)("div",{className:"flex flex-wrap items-center gap-2",children:[(0,t.jsx)("button",{onClick:()=>M(!1),disabled:k,className:"px-4 py-2 rounded-md text-sm font-medium border border-border bg-surface hover:bg-surface-2 disabled:opacity-50",children:"Run"}),(0,t.jsx)("button",{onClick:()=>M(!0),disabled:k,className:"px-4 py-2 rounded-md text-sm font-medium bg-accent text-accent-fg hover:opacity-90 disabled:opacity-50",children:k?"Running…":"Run & Check"}),(0,t.jsx)("button",{onClick:()=>v(e.starter),disabled:k,className:"px-3 py-2 rounded-md text-sm text-muted hover:text-fg disabled:opacity-50",children:"Reset"}),(0,t.jsx)("button",{onClick:()=>T(e=>!e),className:"px-3 py-2 rounded-md text-sm text-muted hover:text-fg ml-auto",children:x?"Hide hint":"Hint"})]}),m&&(0,t.jsx)("p",{className:"text-sm text-muted",children:m}),x&&(0,t.jsx)("p",{className:"text-sm bg-warn-soft text-warn border border-warn/20 rounded-md px-3 py-2",children:e.hint})]}),S&&(0,t.jsxs)("div",{role:"status",className:`rounded-lg px-4 py-3 text-sm border ${S.passed?"bg-success-soft text-success border-success/20":"bg-danger-soft text-danger border-danger/20"}`,children:[(0,t.jsx)("span",{className:"font-semibold",children:S.passed?"Correct.":"Not yet."})," ",S.reason??(S.passed?"Marked solved.":"")]}),_&&(0,t.jsxs)("div",{className:"space-y-2",children:[_.ok?(0,t.jsxs)(t.Fragment,{children:[(0,t.jsxs)("p",{className:"text-xs text-muted",children:["Ran in ",_.ms," ms"]}),y(_.payload)]}):(0,t.jsx)("pre",{className:"text-sm font-mono bg-danger-soft text-danger border border-danger/20 rounded-lg px-3 py-2 overflow-x-auto whitespace-pre-wrap",children:_.error}),_.stdout&&""!==_.stdout.trim()&&(0,t.jsxs)("details",{className:"text-sm",children:[(0,t.jsx)("summary",{className:"cursor-pointer text-muted",children:"stdout"}),(0,t.jsx)("pre",{className:"mt-1 font-mono bg-code-bg border border-border rounded-lg px-3 py-2 overflow-x-auto whitespace-pre-wrap",children:_.stdout})]})]}),(0,t.jsxs)("div",{className:"bg-accent-soft/40 border border-accent/20 rounded-xl p-4 text-sm space-y-1.5",children:[(0,t.jsx)("p",{className:"font-semibold text-accent",children:"Why this matters for a data product"}),(0,t.jsx)("p",{children:e.dpmConnection.text}),L&&(0,t.jsxs)("p",{className:"text-muted",children:["Related:"," ",(0,t.jsx)(a.default,{href:`/kb/${L.slug}`,className:"text-accent underline underline-offset-2",children:L.title})]})]})]})}function p({columns:e,rows:a,maxRows:r=50}){if(0===e.length)return(0,t.jsx)("p",{className:"text-sm text-muted",children:"Query ran, but returned no result set."});let s=a.slice(0,r);return(0,t.jsxs)("div",{className:"overflow-x-auto rounded-lg border border-border",children:[(0,t.jsxs)("table",{className:"min-w-full text-sm font-mono",children:[(0,t.jsx)("thead",{className:"bg-surface-2",children:(0,t.jsx)("tr",{children:e.map(e=>(0,t.jsx)("th",{className:"text-left px-3 py-2 font-semibold border-b border-border",children:e},e))})}),(0,t.jsxs)("tbody",{children:[s.map((e,a)=>(0,t.jsx)("tr",{className:"odd:bg-surface even:bg-surface-2/40",children:e.map((e,a)=>(0,t.jsx)("td",{className:"px-3 py-1.5 border-b border-border whitespace-nowrap",children:null==e?(0,t.jsx)("span",{className:"text-muted italic",children:"NULL"}):String(e)},a))},a)),0===a.length&&(0,t.jsx)("tr",{children:(0,t.jsx)("td",{colSpan:e.length,className:"px-3 py-3 text-muted italic",children:"0 rows"})})]})]}),a.length>r&&(0,t.jsxs)("p",{className:"text-xs text-muted px-3 py-1.5 border-t border-border",children:["Showing ",r," of ",a.length," rows"]})]})}e.s(["PracticeWorkspace",0,function(e){let{exercises:r,title:n,intro:i,reference:c}=e,{data:u,hydrated:h}=(0,o.useProgress)(),p=(0,s.useSyncExternalStore)(l,()=>window.location.hash.replace(/^#/,""),()=>""),f=(0,s.useMemo)(()=>r.find(e=>e.slug===p)??r[0],[r,p]),y=(0,s.useRef)(!e.prepare),[b,w]=(0,s.useState)(null),v=(0,s.useCallback)(async()=>{!y.current&&e.prepare&&(await e.prepare(e=>w(e)),y.current=!0,w(null))},[e]),x=e=>u.exercises[e]?.status??"not_started",T=r.filter(e=>"solved"===x(e.slug)).length,k=d.chapters.map(e=>({chapter:e,items:r.filter(t=>t.chapter===e.number)})).filter(e=>e.items.length>0),E=new Map(r.map((e,t)=>[e.slug,t+1]));return(0,t.jsxs)("div",{className:"grid gap-6 lg:grid-cols-[280px_minmax(0,1fr)]",children:[(0,t.jsxs)("aside",{className:"lg:sticky lg:top-6 self-start min-w-0 lg:max-h-[calc(100vh-3rem)] lg:overflow-y-auto",children:[(0,t.jsx)("h1",{className:"text-xl font-semibold tracking-tight",children:n}),(0,t.jsx)("p",{className:"text-sm text-muted mt-1",children:h?`${T} / ${r.length} solved`:`${r.length} exercises`}),(0,t.jsx)("div",{className:"mt-4 space-y-4",children:k.map(({chapter:e,items:r})=>(0,t.jsxs)("div",{children:[(0,t.jsx)(a.default,{href:`/chapters/${e.number}`,className:"block text-[0.7rem] uppercase tracking-wide text-muted hover:text-fg px-3 mb-1",children:e.week}),(0,t.jsx)("ol",{className:"space-y-0.5",children:r.map(e=>{let a=e.slug===f.slug,r=E.get(e.slug);return(0,t.jsx)("li",{children:(0,t.jsxs)("button",{onClick:()=>{var t;let a;return t=e.slug,void((a=new URL(window.location.href)).hash=t,window.history.replaceState(null,"",a.toString()),window.dispatchEvent(new HashChangeEvent("hashchange")))},className:`w-full text-left px-3 py-1.5 rounded-md text-sm flex items-center gap-2.5 transition-colors ${a?"bg-accent-soft text-accent":"hover:bg-surface-2"}`,children:[(0,t.jsx)(m,{status:h?x(e.slug):"not_started"}),(0,t.jsxs)("span",{className:"text-muted tabular-nums w-5 shrink-0",children:[r,"."]}),(0,t.jsx)("span",{className:"truncate min-w-0",children:e.title})]})},e.slug)})})]},e.number))})]}),(0,t.jsxs)("section",{className:"min-w-0 space-y-5",children:[(0,t.jsxs)("div",{className:"text-sm text-muted space-y-3",children:[i,c]}),(0,t.jsx)(g,{exercise:f,kind:e.kind,ensurePrepared:v,prepStatus:b,run:e.run,grade:e.grade,renderResult:e.renderResult},f.slug)]})]})}],6159),e.s(["PyResultView",0,function({value:e}){if(Array.isArray(e)&&e.length>0&&e.every(e=>e&&"object"==typeof e&&!Array.isArray(e))){let a=Array.from(new Set(e.flatMap(e=>Object.keys(e)))),r=e.map(e=>a.map(t=>e[t]));return(0,t.jsx)(p,{columns:a,rows:r})}return(0,t.jsx)("pre",{className:"text-sm font-mono bg-code-bg border border-border rounded-lg px-3 py-2 overflow-x-auto",children:JSON.stringify(e,null,2)})},"ResultTable",0,p],18994);let f=Date.UTC(2026,0,1);function y(e){return new Date(f+864e5*e).toISOString().slice(0,10)}function b(e){let[t,a,r]=e.split("-").map(Number);return Math.round((Date.UTC(t,a-1,r)-f)/864e5)}function w(e){return String(e).padStart(2,"0")}function v(e,t,a){return`${y(e)} ${w(t)}:${w(a)}:00`}let x=b("2026-08-31"),T=["Northwind Traders","Globex Logistics","Initech Software","Umbrella Health","Hooli Media","Wayne Manufacturing","Stark Analytics","Wonka Foods","Acme Robotics","Vandelay Imports","Pied Piper Cloud","Dunder Paper Co","Sterling Cooper","Cyberdyne Systems","Tyrell Bio","Oscorp Materials","Gringotts Fintech","Massive Dynamic","Aperture Labs","Soylent Nutrition","Bluth Homes","Prestige Worldwide","Wernham Hogg","Los Pollos Foods","Buy n Large Retail","Monarch Solutions","Ollivander Supply","Rekall Travel","Zorg Industries","Nakatomi Trading","Brawndo Beverages","Virtucon","Kwik-E-Mart Group","InGen Life Sciences","Weyland Energy","Cheers Hospitality","Mooby Entertainment","Oceanic Airlines","Paper Street Soap","Sirius Cybernetics"],k=["Retail","Logistics","Technology","Healthcare","Media","Manufacturing","Financial Services","Consumer Goods","Energy","Hospitality"],E=["Priya","Marcus","Elena","Sam","Grace","Tom","Nadia","Liam","Yuki","Carlos","Aisha","Ben","Chloe","Dev","Fatima","Hugo","Ines","Jonas","Keiko","Luis","Maya","Noah","Olivia","Pablo","Rania","Sofia","Tariq","Uma","Victor","Wen"],_=["Shah","Lee","Petrova","Okafor","Muller","Hidayat","Farouk","O'Connor","Tanaka","Mendes","Khan","Novak","Dubois","Rao","Haddad","Silva","Costa","Berg","Sato","Ortiz","Iyer","Fischer","Martin","Rossi","Nasser","Moreno","Ali","Nair","Chen","Larsen"],N=["VP Operations","Data Lead","COO","Founder","Director of Analytics","Procurement Lead","VP Marketing","Plant Manager","Head of Data","Ops Manager","CFO","IT Director"],S=["Jordan Blake","Priya Nair","Meiling Zhao","Diego Alvarez","Amara Osei"],P=null;function A(){return P||(P=function(e=2){let t,a=(t=e>>>0,()=>{let e=t=t+0x6d2b79f5>>>0;return e=Math.imul(e^e>>>15,1|e),(((e^=e+Math.imul(e^e>>>7,61|e))^e>>>14)>>>0)/0x100000000}),r=(e,t)=>e+Math.floor(a()*(t-e+1)),s=e=>e[Math.floor(a()*e.length)],n=e=>a()<e,o=T.map((e,t)=>{let n=a(),o=a();return{account_id:`ACC-${w(t+1).padStart(3,"0")}`,account_name:e,industry:s(k),region:n<.5?"AMER":n<.8?"EMEA":"APAC",tier:o<.25?"Enterprise":o<.65?"Mid-Market":"SMB",created_date:y(-r(30,700))}}),i=[];for(let e of o)for(let t=0;t<2;t++){let t=s(E),a=s(_),r=e.account_name.toLowerCase().replace(/[^a-z]/g,"").slice(0,10);i.push({customer_id:`CUS-${String(i.length+1).padStart(3,"0")}`,account_id:e.account_id,full_name:`${t} ${a}`,role:s(N),email:`${t.toLowerCase()}.${a.toLowerCase().replace(/[^a-z]/g,"")}@${r}.example`})}let l=[],d=[],c={Enterprise:[6e4,22e4],"Mid-Market":[18e3,7e4],SMB:[4e3,2e4]};for(let e=0;e<420;e++){let t=s(o),i=r(0,b("2026-08-20")),u=Number(y(i).slice(5,7)),h=a(),m=h<.35?"Inbound":h<.75?"Outbound":"Referral",g=s(S),[p,f]=c[t.tier],w=500*Math.round(r(p,f)/500),T=.55;"Referral"===m&&(T+=.15),"Inbound"===m&&(T+=.05),"Outbound"===m&&(T-=.1),"AMER"===t.region&&(T+=.05),"Jordan Blake"===g&&(T+=.08),"Meiling Zhao"===g&&(T-=.05);let k="AMER"===t.region&&"Outbound"===m&&(5===u||6===u);k&&(T-=.45);let E={prospecting:[2,12],qualified:[4,18],proposal:[6,24],negotiation:[4,18]},_=i,N="prospecting",P=null,A=(t,a)=>d.push({history_id:`H-${String(d.length+1).padStart(5,"0")}`,deal_id:`DEAL-${String(e+1).padStart(3,"0")}`,stage:t,entered_at:v(a,r(8,18),r(0,59))});A("prospecting",_);let M=["qualified","proposal","negotiation"],L=n(T),O=L?3:r(0,3),j=!1;for(let e=0;e<M.length;e++){let t=N,[a,s]=E[t];if(k&&"negotiation"===t&&([a,s]=[12,30]),_+=r(a,s),!L&&e>=O){_<=x&&(N="closed_lost",P=_,A("closed_lost",_)),j=!0;break}if(_>x){j=!0;break}A(N=M[e],_)}if(!j){let[e,t]=E.negotiation;k&&([e,t]=[12,30]),(_+=r(e,t))<=x&&(N=L?"closed_won":"closed_lost",P=_,A(N,_))}l.push({deal_id:`DEAL-${String(e+1).padStart(3,"0")}`,account_id:t.account_id,owner:g,stage:N,amount:w,source:m,created_date:y(i),closed_date:null===P?null:y(P)})}let u=[],h=(e,t,a,r)=>u.push({transaction_id:`TXN-${String(u.length+1).padStart(4,"0")}`,deal_id:e,amount:t,transaction_date:y(a),type:r});for(let e of l){if("closed_won"!==e.stage||!e.closed_date)continue;let t=b(e.closed_date);if(h(e.deal_id,e.amount,t,"initial"),n(.3)){let a=t+r(20,70);a<=x&&h(e.deal_id,100*Math.round(e.amount*r(8,25)/100/100),a,"upsell")}if(n(.15)){let a=t+r(60,120);a<=x&&h(e.deal_id,100*Math.round(e.amount*r(30,60)/100/100),a,"renewal")}}let m=u.filter(e=>"initial"===e.type);for(let e=0;e<5;e++){let t=m[Math.floor((e+1)*37%m.length)];h(t.deal_id,t.amount,b(t.transaction_date),t.type)}for(let e=0;e<6;e++){let t=d[Math.floor((e+1)*151%d.length)];d.push({...t,history_id:`H-${String(d.length+1).padStart(5,"0")}`})}let g=l.filter(e=>"closed_won"===e.stage);for(let e=0;e<4;e++){let t=g[Math.floor((e+1)*23%g.length)];"closed_won"===t.stage&&(t.stage="negotiation",t.closed_date=null)}let p=l.filter(e=>"closed_lost"===e.stage&&e.closed_date);for(let e=0;e<3;e++)p[Math.floor((e+1)*17%p.length)].closed_date=null;let P=[],A=["crm_deals_ingest","transactions_ingest","gold_sales_metrics"],M=b("2026-04-01");for(let e=M;e<=x;e++){let t=y(e),a=l.filter(t=>b(t.created_date)<=e).length,s=u.filter(t=>b(t.transaction_date)<=e).length;for(let o of A){let i=r(0,40),l="crm_deals_ingest"===o?2:"transactions_ingest"===o?3:4,d="success",c="gold_sales_metrics"===o?r(18,35):r(6,15);"gold_sales_metrics"===o&&("2026-06-14"===t||"2026-06-15"===t||"2026-06-16"===t)&&(d="failed"),"crm_deals_ingest"===o&&"2026-07-22"===t&&(d="failed"),"transactions_ingest"===o&&"2026-05-09"===t&&(d="failed"),"success"===d&&n(.04)&&(d="late",c+=r(40,90));let u="crm_deals_ingest"===o?a:"transactions_ingest"===o?s:a+s;u+=r(-3,3);let h="failed"===d?0:u-r(0,4);"crm_deals_ingest"===o&&"2026-07-05"===t&&(h=Math.round(.3*h)),P.push({run_id:`RUN-${String(P.length+1).padStart(4,"0")}`,pipeline:o,run_date:t,started_at:v(e,l,i),finished_at:"failed"===d?null:v(e,l+Math.floor((i+c)/60),(i+c)%60),status:d,rows_in:Math.max(0,u),rows_out:Math.max(0,h)})}}let L=[],O=[],j=["Sales Rep","Sales Rep","Sales Rep","Sales Rep","Sales Manager","Sales Manager","RevOps","Finance","Executive"];for(let e=0;e<32;e++)O.push({id:`U-${w(e+1)}`,role:j[e%j.length]});let R=b("2026-06-01");for(let e=M;e<=x;e++){let t=new Date(f+864e5*e).getUTCDay();if(0===t||6===t)continue;let a=e<R?r(4,8):r(0,2);for(let t=0;t<a;t++){let t=O[r(0,11)];L.push({view_id:`V-${String(L.length+1).padStart(4,"0")}`,dashboard:"Pipeline Report (legacy)",viewer_id:t.id,viewer_role:t.role,viewed_at:v(e,r(8,18),r(0,59))})}if(e>=R){let t=Math.floor((e-R)/7),a=r(3,6)+Math.min(2*t,18),s=Math.min(32,10+2*t);for(let t=0;t<a;t++){let t=O[r(0,s-1)];L.push({view_id:`V-${String(L.length+1).padStart(4,"0")}`,dashboard:"Sales Funnel Accelerator",viewer_id:t.id,viewer_role:t.role,viewed_at:v(e,r(8,18),r(0,59))})}}}return{accounts:o,customers:i,deals:l,deal_stage_history:d,transactions:u,pipeline_runs:P,dashboard_views:L}}()),P}let M=`
