(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,86969,e=>{"use strict";var t=e.i(18050),a=e.i(22016),s=e.i(21683),r=e.i(71645),o=e.i(82364);let n={judgment:"Judgment call",concept:"Concept check","sql-prediction":"Read the SQL"},i={judgment:"bg-accent-soft text-accent",concept:"bg-success-soft text-success","sql-prediction":"bg-warn-soft text-warn"};function l({questions:e,answers:d,onAnswer:c,onReset:u}){let h=e.findIndex(e=>!d[e.id]),[m,g]=(0,r.useState)(-1===h?0:h),p=e[m],f=e.filter(e=>d[e.id]).length,y=e.filter(e=>d[e.id]?.correct).length,b=f===e.length,w=p?d[p.id]:void 0,x=p?(0,o.getKbEntry)(p.kbSlug):void 0;return p?(0,t.jsxs)("div",{className:"bg-surface border border-border rounded-xl p-5 sm:p-6 space-y-5",children:[(0,t.jsxs)("div",{className:"flex flex-wrap items-center justify-between gap-2",children:[(0,t.jsxs)("div",{className:"flex items-center gap-2",children:[(0,t.jsx)("span",{className:`text-xs px-2 py-0.5 rounded-full font-medium ${i[p.kind]}`,children:n[p.kind]}),(0,t.jsxs)("span",{className:"text-sm text-muted tabular-nums",children:["Question ",m+1," of ",e.length]})]}),(0,t.jsx)("div",{className:"flex items-center gap-1",children:e.map((e,a)=>{let s=d[e.id],r=s?s.correct?"bg-success":"bg-danger":a===m?"bg-accent":"bg-border";return(0,t.jsx)("button",{onClick:()=>g(a),"aria-label":`Go to question ${a+1}`,className:`w-2.5 h-2.5 rounded-full ${r} ${a===m?"ring-2 ring-accent-soft":""}`},e.id)})})]}),(0,t.jsx)(s.Markdown,{className:"text-[0.98rem]",children:p.prompt}),(0,t.jsx)("ol",{className:"space-y-2",children:p.options.map((e,a)=>{let s=w?.chosen===a,r=a===p.correctIndex,o="border-border hover:border-accent bg-surface";return w&&(o=r?"border-success bg-success-soft":s?"border-danger bg-danger-soft":"border-border opacity-70"),(0,t.jsx)("li",{children:(0,t.jsx)("button",{disabled:!!w,onClick:()=>c(p.id,a,r),className:`w-full text-left rounded-lg border px-4 py-3 text-sm transition-colors disabled:cursor-default ${o}`,children:(0,t.jsxs)("div",{className:"flex gap-3",children:[(0,t.jsxs)("span",{className:"font-mono text-muted shrink-0",children:[String.fromCharCode(65+a),"."]}),(0,t.jsxs)("div",{className:"space-y-1.5",children:[(0,t.jsx)("p",{children:e.text}),w&&(0,t.jsxs)("p",{className:`text-xs ${r?"text-success":s?"text-danger":"text-muted"}`,children:[r?"Best answer. ":s?"Your pick. ":"",e.explanation]})]})]})})},a)})}),(0,t.jsxs)("div",{className:"flex flex-wrap items-center gap-3 text-sm",children:[w&&x&&(0,t.jsxs)(a.default,{href:`/kb/${x.slug}`,className:"text-accent underline underline-offset-2",children:["Read: ",x.title]}),(0,t.jsxs)("span",{className:"ml-auto text-muted tabular-nums",children:[y," / ",f," correct"]}),m>0&&(0,t.jsx)("button",{onClick:()=>g(e=>e-1),className:"px-3 py-1.5 rounded-md border border-border hover:bg-surface-2",children:"Back"}),w&&m<e.length-1&&(0,t.jsx)("button",{onClick:()=>g(e=>e+1),className:"px-3 py-1.5 rounded-md bg-accent text-accent-fg font-medium hover:opacity-90",children:"Next"}),b&&(0,t.jsx)("button",{onClick:()=>{u(),g(0)},className:"px-3 py-1.5 rounded-md text-muted hover:text-fg",children:"Retake quiz"})]})]}):null}var d=e.i(47371),c=e.i(77272),u=e.i(8908),h=e.i(26033),m=e.i(79922),g=e.i(74581);function p({n:e,title:a,done:s,children:r}){return(0,t.jsxs)("section",{className:"grid grid-cols-[2rem_minmax(0,1fr)] gap-x-3 sm:gap-x-4",children:[(0,t.jsxs)("div",{className:"flex flex-col items-center",children:[(0,t.jsx)("span",{className:`w-8 h-8 rounded-full flex items-center justify-center text-sm font-semibold shrink-0 ${s?"bg-success text-white":"bg-accent-soft text-accent"}`,children:s?"✓":e}),(0,t.jsx)("span",{className:"flex-1 w-px bg-border my-2"})]}),(0,t.jsxs)("div",{className:"pb-10 min-w-0",children:[(0,t.jsx)("h2",{className:"text-lg font-semibold mb-3 leading-8",children:a}),r]})]})}function f({href:e,title:s,status:r}){return(0,t.jsx)("li",{children:(0,t.jsxs)(a.default,{href:e,className:"flex items-center gap-3 px-3 py-2 rounded-md hover:bg-surface-2 text-sm",children:[(0,t.jsx)("span",{className:`w-2 h-2 rounded-full shrink-0 ${"solved"===r?"bg-success":"attempted"===r?"bg-warn":"bg-border"}`}),(0,t.jsx)("span",{className:"flex-1 min-w-0 break-words",children:s}),(0,t.jsx)("span",{className:"text-xs text-muted",children:"solved"===r?"Solved":"attempted"===r?"In progress":"Open"})]})})}e.s(["ChapterView",0,function({number:e}){let r=(0,d.getChapter)(e),{data:n,hydrated:i,recordQuizAnswer:y,resetQuiz:b}=(0,g.useProgress)(),w=(0,m.chapterProgress)(n,e),x=(0,c.quizForChapter)(e),v=(0,u.sqlExercisesForChapter)(e),k=(0,h.pythonExercisesForChapter)(e),j=d.chapters.find(t=>t.number===e-1),P=d.chapters.find(t=>t.number===e+1),S=e=>i?n.exercises[e]?.status??"not_started":"not_started";return(0,t.jsxs)("article",{className:"max-w-3xl space-y-8",children:[(0,t.jsxs)("header",{className:"space-y-2",children:[(0,t.jsx)(a.default,{href:"/",className:"text-sm text-muted hover:text-fg",children:"← Your six weeks"}),(0,t.jsx)("p",{className:"text-xs uppercase tracking-wide text-accent font-semibold",children:r.week}),(0,t.jsx)("h1",{className:"text-3xl font-semibold tracking-tight",children:r.title}),(0,t.jsx)("p",{className:"text-muted",children:r.tagline}),i&&(0,t.jsxs)("div",{className:"flex items-center gap-3 pt-1",children:[(0,t.jsx)("div",{className:"h-1.5 flex-1 rounded-full bg-border overflow-hidden",children:(0,t.jsx)("div",{className:"h-full bg-accent transition-all",style:{width:`${Math.round(100*w.fraction)}%`}})}),(0,t.jsx)("span",{className:"text-xs text-muted tabular-nums",children:w.complete?"Complete":`${w.quizAnswered}/${w.quizTotal} decisions \xb7 ${w.sqlSolved}/${w.sqlTotal} SQL`})]})]}),1===e&&(0,t.jsxs)("aside",{className:"bg-surface-2/60 border border-border rounded-xl p-4 text-sm",children:[(0,t.jsx)("p",{className:"font-semibold mb-2",children:"Who you'll be dealing with"}),(0,t.jsx)("ul",{className:"grid gap-2 sm:grid-cols-2",children:d.CAST.map(e=>(0,t.jsxs)("li",{children:[(0,t.jsx)("span",{className:"font-medium",children:e.name})," ",(0,t.jsxs)("span",{className:"text-muted",children:["· ",e.role]}),(0,t.jsx)("p",{className:"text-muted text-xs mt-0.5",children:e.agenda})]},e.name))})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)(p,{n:1,title:"The brief",done:i&&"brief"!==w.nextStep,children:(0,t.jsx)("div",{className:"bg-surface border border-border rounded-xl p-5 sm:p-6",children:(0,t.jsx)(s.Markdown,{children:r.brief})})}),(0,t.jsx)(p,{n:2,title:"Read",done:i&&"brief"!==w.nextStep,children:(0,t.jsx)("ul",{className:"grid grid-cols-1 gap-2 sm:grid-cols-2",children:r.readings.map(e=>{let s=(0,o.getKbEntry)(e);return s?(0,t.jsx)("li",{children:(0,t.jsxs)(a.default,{href:`/kb/${e}`,className:"block h-full bg-surface border border-border rounded-lg p-3 hover:border-accent text-sm",children:[(0,t.jsx)("p",{className:"font-medium",children:s.title}),(0,t.jsx)("p",{className:"text-xs text-muted mt-1 line-clamp-2",children:s.summary})]})},e):null})})}),(0,t.jsxs)(p,{n:3,title:"Decide",done:i&&w.quizAnswered===w.quizTotal,children:[(0,t.jsxs)("p",{className:"text-sm text-muted mb-3",children:[x.length," questions: judgment calls, concept checks, and reading SQL. Every option comes with a rationale, so a wrong pick still teaches something."]}),i?(0,t.jsx)(l,{questions:x,answers:n.quiz,onAnswer:y,onReset:()=>b(x.map(e=>e.id))}):(0,t.jsx)("div",{className:"h-40 bg-surface border border-border rounded-xl animate-pulse"})]}),(0,t.jsxs)(p,{n:4,title:"Build",done:i&&w.sqlSolved===w.sqlTotal,children:[(0,t.jsx)("p",{className:"text-sm text-muted mb-3",children:"Compute it yourself. SQL is required to complete the chapter; the pandas twins are extra credit."}),(0,t.jsxs)("div",{className:"grid grid-cols-1 gap-4 sm:grid-cols-2",children:[(0,t.jsxs)("div",{className:"bg-surface border border-border rounded-xl p-2 min-w-0",children:[(0,t.jsxs)("p",{className:"text-xs uppercase tracking-wide text-muted px-3 pt-2 pb-1",children:["SQL · ",w.sqlSolved,"/",w.sqlTotal]}),(0,t.jsx)("ul",{children:v.map(e=>(0,t.jsx)(f,{href:`/practice/sql#${e.slug}`,title:e.title,status:S(e.slug)},e.slug))})]}),(0,t.jsxs)("div",{className:"bg-surface border border-border rounded-xl p-2 min-w-0",children:[(0,t.jsxs)("p",{className:"text-xs uppercase tracking-wide text-muted px-3 pt-2 pb-1",children:["Python · ",k.length?`${w.pySolved}/${w.pyTotal}`:"none yet"]}),k.length?(0,t.jsx)("ul",{children:k.map(e=>(0,t.jsx)(f,{href:`/practice/python#${e.slug}`,title:e.title,status:S(e.slug)},e.slug))}):(0,t.jsx)("p",{className:"text-sm text-muted px-3 pb-3",children:"Python exercises for this chapter arrive in the next pass."})]})]})]}),(0,t.jsx)(p,{n:5,title:"Debrief",done:i&&w.complete,children:i&&w.complete?(0,t.jsx)("div",{className:"bg-success-soft/40 border border-success/20 rounded-xl p-5 sm:p-6",children:(0,t.jsx)(s.Markdown,{children:r.debrief})}):(0,t.jsx)("div",{className:"bg-surface-2/60 border border-dashed border-border rounded-xl p-5 text-sm text-muted",children:"Finish the decision quiz and the SQL exercises to unlock the debrief: what a good week looked like, and what carries into the next one."})})]}),(0,t.jsxs)("nav",{className:"flex justify-between text-sm border-t border-border pt-4",children:[j?(0,t.jsxs)(a.default,{href:`/chapters/${j.number}`,className:"text-muted hover:text-fg",children:["← ",j.week]}):(0,t.jsx)("span",{}),P?(0,t.jsxs)(a.default,{href:`/chapters/${P.number}`,className:"text-accent hover:underline underline-offset-2",children:[P.week," →"]}):(0,t.jsx)(a.default,{href:"/",className:"text-accent hover:underline underline-offset-2",children:"Back to overview →"})]})]})}],86969)},87110,e=>{"use strict";let t=[{slug:"what-is-a-data-product-manager",title:"What is a Data Product Manager?",category:"definition",tags:["role","fundamentals"],summary:"A DPM sits at the intersection of data, technology, and business, managing data warehouses, platforms, pipelines, and ML models the way a PM manages a product.",body:`A **Data Product Manager (DPM)** is a specialized role at the intersection of
